...
namespace OpenXMLExcel.Models
{
    public class ExcelLeitura
    {
        ...
        public ExcelDados ReadExcel(HttpPostedFileBase file)
        {
            ...
            {
                data.Status.Message = "Por favor fazer um upload de um arquivo com conteúdo.";
                return data;
            }
            ...
            {
                data.Status.Message
                    = "Por favor fazer um upload de um arquivo excel válido da version 2007 ou maior.";
                return data;
            }
            ...
            {
                data.Status.Message = "Não foi possível abrir o arquivo.";
                return data;
            }
